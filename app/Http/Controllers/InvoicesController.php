...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('pic')) {
         ...
         $user = User::first();
         Notification::send($user, new AddNotification($invoice_id));
    ...
    public function Invoice_Paid(){
        ...
        $invoice_page = "الفواتير المدفوعة";
        return view('invoices/invoices_paid',compact('invoices','invoice_page'));
    }

    public function Invoice_UnPaid(){
        $invoices = Invoices::where('Value_Status', 2)->get();
        $invoice_page = "الفواتير غير المدفوعة";
        return view('invoices/invoices_paid',compact('invoices','invoice_page'));
    }

    public function Invoice_Partial(){
        $invoices = Invoices::where('Value_Status', 3)->get();
        $invoice_page = "الفواتير المدفوعة جزئيا ";
        return view('invoices/invoices_paid',compact('invoices','invoice_page'));
    }
