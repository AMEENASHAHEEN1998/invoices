                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6>Khamees Company</h6>
                                <p>Alandownessy St., Talzater Town, Gaza Country <br>
                                    Tel No: +972-595423969<br>
                                    Email: ameena.sh.98@gmail.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                <label class="tx-gray-600">موجهة الى</label>
                                <div class="billed-to">
