<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<h6  style="padding-top : 25px ; padding-bottom: 5px; text-align: center">Eng. Ameena Shaheen</h6> <hr>
			<div class="main-sidemenu" style="margin-top: 10px;">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/face.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
